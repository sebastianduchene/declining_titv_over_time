...
- The sequence data used for the detailed analyes are available as fasta alignments in data_sets_detailed.

- The accession numbers for the broad-scale analyses are available in ACCNS.xlsx

- The code to simulate the behaviour of the gamma distribution of among-site rate heterogeity is available in gamma_rates.R. This code can be run in R to reproduce Figure 2 in the paper.
